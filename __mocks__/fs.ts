...
fs = {
    ...
    * ```
    *
    * The function takes in an array of mock files with paths, content, and type, and organizes them by their directories.
    * Each directory will hold an array of its respective files and subdirectories. The content of each file can be a string, while directories will have a `null` content.
    * 
